...
| 23 | Money — Spending limits | how this month sits against limits they set themselves | edit a limit (spend bar vs limit tick; overage is the screen's one --short use) |
